<?php
/*
Template Name: Вентиляция бассейна
*/
?>
<?php get_header(); ?>
    ...
    <main class="page-insert page-pool-ventilation">
            ...
            <div class="container">
                ...
                <ul class="recommendations-list">
                    ...
                    <li class="recommendations-list__item">
                        ...
                        <span class="recommendations-list__item-text"> 
                            Приток воздуха на <br> человека > 80 м<sup>3</sup>/час
                        </span>
                    </li>
                </ul>
            </div>
            ...
            <div class="container">
                ...
                <ul class="danger-list">
                    <li class="danger-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/danger/1.jpg" alt="" class="danger-item__image">
                        <span class="danger-item__text">
                            Чрезмерная нагрузка на сердце из-за повышенной влажности и концентрации СО2 
                        </span>
                    </li>
                    <li class="danger-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/danger/2.jpg" alt="" class="danger-item__image">
                        <span class="danger-item__text">
                            Скользкий пол из-за образования водяной пленки
                        </span>
                    </li>
                    <li class="danger-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/danger/3.jpg" alt="" class="danger-item__image">
                        <span class="danger-item__text">
                            Развитие грибка и плесени, опасных для человека и разрушающих отделочные материалы
                        </span>
                    </li>
                    <li class="danger-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/danger/4.jpg" alt="" class="danger-item__image">
                        <span class="danger-item__text">
                            Переохлаждение и простуда из-за сквозняков и неправильного распределения воздуха
                        </span>
                    </li>
                    <li class="danger-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/danger/5.jpg" alt="" class="danger-item__image">
                        <span class="danger-item__text">
                            Конденсат на окнах и стеклянной крыше
                        </span>
                    </li>
                    <li class="danger-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/danger/6.jpg" alt="" class="danger-item__image">
                        <span class="danger-item__text">
        ...
        <section class="types">
            <div class="container">
                ...
                <ul class="types-list">
                    <li class="types-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/types/1.jpg" alt="" class="types-item__image">
                    ...
                    <li class="types-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/types/2.jpg" alt="" class="types-item__image">
                        <div class="types-item__content">
                            <h4 class="types-item__title">
                    ...
                    <li class="types-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/types/3.jpg" alt="" class="types-item__image">
                        <div class="types-item__content">
                            <h4 class="types-item__title">
                    ...
                    <li class="types-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/types/4.jpg" alt="" class="types-item__image">
                        <div class="types-item__content">
                            <h4 class="types-item__title">
                    ...
                    <li class="types-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/types/5.jpg" alt="" class="types-item__image">
                        <div class="types-item__content">
                            <h4 class="types-item__title">
...
<?php include('part/blog.php'); ?>
        <section class="plus">
            <div class="container">
                ...
                <ul class="plus-list">
                    <li class="plus-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/plus/1.jpg" alt="" class="plus-item__image">
                    ...
                    <li class="plus-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/plus/2.jpg" alt="" class="plus-item__image">
                        <div class="plus-item__content">
                            <h4 class="plus-item__title">
                                Минимум шума
                            </h4>
                    ...
                    <li class="plus-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/plus/3.jpg" alt="" class="plus-item__image">
                        <div class="plus-item__content">
                            <h4 class="plus-item__title">
                                Рекуперация тепла
                            </h4>
                    ...
                    <li class="plus-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/plus/4.jpg" alt="" class="plus-item__image">
                        <div class="plus-item__content">
                            <h4 class="plus-item__title">
                    ...
                    <li class="plus-item">
                        <img src="<?php bloginfo('template_directory'); ?>/img/pool/plus/5.jpg" alt="" class="plus-item__image">
                        <div class="plus-item__content">
                            <h4 class="plus-item__title">
                                Свои специалисты
                            </h4>
                    ...
                    <div class="cond-brands__list swiper-container">
                        <div class="cond-brands__slider swiper-wrapper">
                            <div class="cond-brands__item swiper-slide col-12 col-md-6 col-lg-3">
                                <img src="<?php bloginfo('template_directory'); ?>/img/pool/brands/1.jpg" alt="">
                            </div>
                            <div class="cond-brands__item swiper-slide col-12 col-md-6 col-lg-3">
                                <img src="<?php bloginfo('template_directory'); ?>/img/pool/brands/2.jpg" alt="">
                            </div>
                            <div class="cond-brands__item swiper-slide col-12 col-md-6 col-lg-3">
                                <img src="<?php bloginfo('template_directory'); ?>/img/pool/brands/3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stages-list">
                    <div class="stages-item">
                        <div class="stages-item__image">
                            <img src="<?php bloginfo('template_directory'); ?>/img/pool/stages/1.jpg" alt="">
                    ...
                    <div class="stages-item">
                        <div class="stages-item__image">
                            <img src="<?php bloginfo('template_directory'); ?>/img/pool/stages/2.jpg" alt="">
                    ...
                    <div class="stages-item">
                        <div class="stages-item__image">
                            <img src="<?php bloginfo('template_directory'); ?>/img/pool/stages/3.jpg" alt="">
