                                        ...
                                        <div class="nav-tab__info col-sm-9">
                                            <div class="row">
                                                <div class="tab-content w-100" id="v-pills-tabContent">
                                                    <div class="tab-pane fade show active" id="v-pills-family"
                                                    ...
                                                    <div class="tab-pane fade" id="v-pills-ltr" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane fade" id="v-pills-hp" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane fade" id="v-pills-hp-1" role="tabpanel"
                                                        aria-labelledby="v-pills-hp-tab">
                                                        <div class="col-sm-8">
